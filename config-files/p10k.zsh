# Generated by Powerlevel10k configuration wizard on 2026-04-18 at 14:18 WIB.
...
() {
  ...
  #  Context format when running with privileges: bold user@hostname.
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%F{208}%n%f%F{15}@%f%F{208}%m%f'

  # Context format when in SSH without privileges: user@hostname.
   typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%F{208}%n%f%F{15}@%f%F{208}%m%f'

  # Default context format (no privileges, no SSH): user@hostname.
   typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{208}%n%f%F{15}@%f%F{208}%m%f'
